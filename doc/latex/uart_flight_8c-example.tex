...
uint8\_t state = 0; \textcolor{comment}{// Bit 0: Motor, Bit 1: PID}
uint8\_t speed = 10;
...
\textcolor{keywordtype}{void} statusTask(\textcolor{keywordtype}{void}) \{
    ...
    \textcolor{keywordflow}{if} ((\hyperlink{group__time_ga158463b7abdb2191a9a364bce1faac83}{getSystemTime}() - last) >= STATUSDELAY) \{
        last = \hyperlink{group__time_ga158463b7abdb2191a9a364bce1faac83}{getSystemTime}();
...
\textcolor{keywordtype}{void} motorToggle(\textcolor{keywordtype}{void}) \{
    \textcolor{keywordflow}{if} (state & 0x01) \{
        state &= ~0x01;
