...
\hypertarget{group__mag_gade4e63fac819c67040e374f08d2d7230}{\index{Magnetometer Driver@{Magnetometer Driver}!M\-A\-G\-\_\-\-A\-D\-D\-R\-E\-S\-S@{M\-A\-G\-\_\-\-A\-D\-D\-R\-E\-S\-S}}
\index{M\-A\-G\-\_\-\-A\-D\-D\-R\-E\-S\-S@{M\-A\-G\-\_\-\-A\-D\-D\-R\-E\-S\-S}!Magnetometer Driver@{Magnetometer Driver}}
...
\begin{DoxyCode}
49              \{
50     \hyperlink{group__mag_gga3af649d913d146d6654db2354d88c18aa18e06791b32b1772765ff7e54d3e24fd}{r1g3} = 1, 
51     \hyperlink{group__mag_gga3af649d913d146d6654db2354d88c18aa8cab223a26c8b984d14dd7214ec4f5f6}{r1g9} = 2, 
52     \hyperlink{group__mag_gga3af649d913d146d6654db2354d88c18aa19f90e5cf717669e72908f8d8a1c9f89}{r2g5} = 3, 
53     \hyperlink{group__mag_gga3af649d913d146d6654db2354d88c18aa402a6d56b75bc48c8521500dd8b38bd8}{r4g0} = 4, 
54     \hyperlink{group__mag_gga3af649d913d146d6654db2354d88c18aaa7401534bd82cade38cbb47c0ff4223e}{r4g7} = 5, 
55     \hyperlink{group__mag_gga3af649d913d146d6654db2354d88c18aa815faf18742b2b13ba477eed930851f4}{r5g6} = 6, 
56     \hyperlink{group__mag_gga3af649d913d146d6654db2354d88c18aa1cb5526ddb90c9b33beb87c0d5ad97ee}{r8g1} = 7, 
57 \} \hyperlink{group__mag_ga3af649d913d146d6654db2354d88c18a}{MagRange};
\end{DoxyCode}
...
\begin{DoxyCode}
76                           \{
77     \textcolor{keywordflow}{if} ((r <= 0) || (r >= 8)) \{
78         \textcolor{keywordflow}{return} \hyperlink{group__error_gga2c3e4bb40f36b262a5214e2da2bca9c5a49ccf277a69dd938c591928aa27c66cc}{ARGUMENT\_ERROR};
79     \}
80     \hyperlink{group__error_ga2c3e4bb40f36b262a5214e2da2bca9c5}{Error} e = \hyperlink{group__mag_gafaf03e3013fe2046847afc2518f23eed}{magWriteRegister}(\hyperlink{group__mag_ga54eabf3b296f6550c9f6d9826020c623}{MAGREG\_MR}, 0x00); \textcolor{comment}{// Continuous Conversion}
81     \textcolor{keywordflow}{if} (e != \hyperlink{group__error_gga2c3e4bb40f36b262a5214e2da2bca9c5ac7f69f7c9e5aea9b8f54cf02870e2bf8}{SUCCESS}) \{
82         \textcolor{keywordflow}{return} e;
83     \}
84     e = \hyperlink{group__mag_gafaf03e3013fe2046847afc2518f23eed}{magWriteRegister}(\hyperlink{group__mag_ga42f59dd3e4a9cb4d8d4dd4a1019b6ab5}{MAGREG\_CRB}, (r << 5)); \textcolor{comment}{// Set Range}
85     \hyperlink{group__mag_gaae12e12b371d0bcebe05462384a519a2}{magRange} = r;
86     \textcolor{keywordflow}{return} e;
87 \}
\end{DoxyCode}
...
142         \textcolor{keywordflow}{case} \hyperlink{group__mag_gga3af649d913d146d6654db2354d88c18aaa7401534bd82cade38cbb47c0ff4223e}{r4g7}:
143             v->\hyperlink{struct_vector3f_af88b946fb90d5f08b5fb740c70e98c10}{x} = (((double)x) * 4.7 / MAG\_NORMALIZE);
144             v->\hyperlink{struct_vector3f_ab927965981178aa1fba979a37168db2a}{y} = (((double)y) * 4.7 / MAG\_NORMALIZE);
145             v->\hyperlink{struct_vector3f_ab3e6ed577a7c669c19de1f9c1b46c872}{z} = (((double)z) * 4.7 / MAG\_NORMALIZE);
146             \textcolor{keywordflow}{break};
147         \textcolor{keywordflow}{case} \hyperlink{group__mag_gga3af649d913d146d6654db2354d88c18aa815faf18742b2b13ba477eed930851f4}{r5g6}:
148             v->\hyperlink{struct_vector3f_af88b946fb90d5f08b5fb740c70e98c10}{x} = (((double)x) * 5.6 / MAG\_NORMALIZE);
149             v->\hyperlink{struct_vector3f_ab927965981178aa1fba979a37168db2a}{y} = (((double)y) * 5.6 / MAG\_NORMALIZE);
150             v->\hyperlink{struct_vector3f_ab3e6ed577a7c669c19de1f9c1b46c872}{z} = (((double)z) * 5.6 / MAG\_NORMALIZE);
151             \textcolor{keywordflow}{break};
152         \textcolor{keywordflow}{case} \hyperlink{group__mag_gga3af649d913d146d6654db2354d88c18aa1cb5526ddb90c9b33beb87c0d5ad97ee}{r8g1}:
153             v->\hyperlink{struct_vector3f_af88b946fb90d5f08b5fb740c70e98c10}{x} = (((double)x) * 8.1 / MAG\_NORMALIZE);
154             v->\hyperlink{struct_vector3f_ab927965981178aa1fba979a37168db2a}{y} = (((double)y) * 8.1 / MAG\_NORMALIZE);
155             v->\hyperlink{struct_vector3f_ab3e6ed577a7c669c19de1f9c1b46c872}{z} = (((double)z) * 8.1 / MAG\_NORMALIZE);
156             \textcolor{keywordflow}{break};
157         \textcolor{keywordflow}{default}:
158             \textcolor{keywordflow}{return} \hyperlink{group__error_gga2c3e4bb40f36b262a5214e2da2bca9c5a49ccf277a69dd938c591928aa27c66cc}{ARGUMENT\_ERROR};
159     \}
160 
161     \textcolor{keywordflow}{return} \hyperlink{group__error_gga2c3e4bb40f36b262a5214e2da2bca9c5ac7f69f7c9e5aea9b8f54cf02870e2bf8}{SUCCESS};
162 \}
\end{DoxyCode}
