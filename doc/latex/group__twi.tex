...
Referenced by acc\-Read(), gyro\-Read(), mag\-Read(), and mag\-Write\-Register().
...
Referenced by acc\-Read(), gyro\-Read(), mag\-Read(), mag\-Write\-Register(), and twi\-Rep\-Start().
...
Referenced by mag\-Write\-Register().
